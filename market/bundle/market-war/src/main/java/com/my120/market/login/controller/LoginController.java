...
public class LoginController {
    ...
    public String loginAction(ModelMap model, String userName, String password, HttpServletRequest req,
    ...
    public String logoutAction(ModelMap model, HttpServletRequest req, HttpServletResponse res) {
        HttpSession session = req.getSession();
    ...
    public String toMmodifyPasswordAction(ModelMap model) {
    ...
    public String modifyPasswordAction(ModelMap model, String oldPassWord, String newPassWord, HttpServletRequest req) {
